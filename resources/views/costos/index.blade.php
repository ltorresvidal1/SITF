...
<div class="ms-auto">
    <a href="{{route('costos.create',$clientes->nombre)}}" class="btn btn-primary"><i class="fa fa-plus-circle fa-fw me-1"></i> Crear Costos</a>
</div>
@endsection
@section('tituloformulario','Costos')
@section('principalformulario','COSTOS')
@section('accionformulario','TODOS')
@section('descripcionformulario','Listado De Costos por Fincas')
