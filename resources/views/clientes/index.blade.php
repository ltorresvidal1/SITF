...
<div class="ms-auto">
    <a href="{{route('clientes.create')}}" class="btn btn-primary"><i class="fa fa-plus-circle fa-fw me-1"></i> Crear Prestadores</a>
</div>
@endsection
@section('tituloformulario','Prestadores')
@section('principalformulario','PRESTADORES')
@section('accionformulario','TODOS')
@section('descripcionformulario','Listado De Prestadores Creados')
