...
@endpush
@section('title','Editar Prestadores')

@section('nombrevista','Prestadores')
@section('hrefformulario')
{{route('clientes.index')}}
@endsection

@section('tituloformulario','Prestadores')
@section('principalformulario','PRESTADORES')
@section('accionformulario','EDITAR')
@section('descripcionformulario','Editar Prestador')
                                                ...
                                                @method('PUT')
                                                    ...
                                                    <div class="row">    
                                                        ...
                                                        <div class="form-group col-3 m-0">   
                                                            <br>                                                     
                                                            <button type="submit" class="btn btn-primary">Editar Prestador</button>
                                                        </div>
                                                    </div>
